...
# as list below is getting long, it can be replace with line beneath, and views added to each path
...
urlpatterns = [
    ...
    # <> is the mechcanism which item id makes its way from links or forms in templates, 
